...
<header class="bg-black shadow-sm dark:shadow-zinc-800/50 sticky top-0 z-10">
    <div class="container mx-auto py-4 flex justify-between items-center">
        <div class="flex items-center space-x-2">
            ...
            <h2 class="text-sm sm:text-base bg-gradient-to-r from-gray-900 to-gray-500 dark:from-gray-100 dark:to-gray-400 bg-clip-text text-transparent font-bold">
                | UAI
            </h2>
        </div>
        ...
        <nav class="hidden md:flex space-x-8 items-center">
            <a href="/" class="text-gray-700 dark:text-zinc-300 hover:text-blue-900 dark:hover:text-blue-400 relative after:absolute after:bottom-[-4px] after:left-0 after:h-0.5 after:w-0 after:bg-blue-900 dark:after:bg-blue-400 after:transition-all hover:after:w-full">Inicio</a>
            <a href="/docs" class="text-gray-700 dark:text-zinc-300 hover:text-blue-900 dark:hover:text-blue-400 relative after:absolute after:bottom-[-4px] after:left-0 after:h-0.5 after:w-0 after:bg-blue-900 dark:after:bg-blue-400 after:transition-all hover:after:w-full">Documentación</a>
            {#if $session.data}
                <a href="/form" class="text-gray-700 dark:text-zinc-300 hover:text-blue-900 dark:hover:text-blue-400 relative after:absolute after:bottom-[-4px] after:left-0 after:h-0.5 after:w-0 after:bg-blue-900 dark:after:bg-blue-400 after:transition-all hover:after:w-full">Formulario</a>
            {/if}
    ...
    {#if isMenuOpen}
        <div class="md:hidden bg-white dark:bg-zinc-800 py-2 px-4 shadow-md dark:shadow-zinc-800/50">
            <nav class="flex flex-col space-y-3">
                <a href="/" class="py-2 text-gray-700 dark:text-zinc-300 hover:text-blue-900 dark:hover:text-blue-400" onclick={toggleMenu}>Inicio</a>
                <a href="/docs" class="py-2 text-gray-700 dark:text-zinc-300 hover:text-blue-900 dark:hover:text-blue-400" onclick={toggleMenu}>Documentación</a>
                <a href="/form" class="py-2 text-gray-700 dark:text-zinc-300 hover:text-blue-900 dark:hover:text-blue-400" onclick={toggleMenu}>Formulario</a>
            </nav>
        </div>
    {/if}
</header>